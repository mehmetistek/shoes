...
const Card = ({item}:Props) => {
  ...
  return (
    <div className="flex flex-col justify-between">
     ...
     <Link className="bg-gray-dark text-white font-medium px-4
      py-2 rounded-[8px] transition hover:bg-black text-center flex
       items-center justify-center gap-1  " to={`/detail/${item.id}`}>
